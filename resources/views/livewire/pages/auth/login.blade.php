...
<div class="flex justify-center items-center min-h-screen bg-white-50">
    <div class="w-full sm:w-[70%] lg:w-[40%] bg-white  animate-fade-in px-8 py-10">
        <!-- Custom Branding -->
        ...
        <form wire:submit="login" class="space-y-6">
            ...
            <div>
                ...
                <input wire:model="form.email" id="email" type="email" required autofocus
                    ...
                    class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 text-gray-800 placeholder-gray-400 px-4 py-3 transition-all duration-300 hover:shadow-sm">
